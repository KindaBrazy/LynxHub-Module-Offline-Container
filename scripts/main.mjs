import { i as isWin, g as getVenvPythonPath, p as parseFilesToArgs, a as parseArgsToFiles, b as getCdCommand, c as parseStringToArgs, d as parseArgsToString, e as parseFilesToArgs$1, f as parseArgsToFiles$1, h as parseStringToArgs$1, j as parseArgsToString$1, A as ALLTALK_ID, k as AG_ID, l as parseArgsToString$2, m as parseStringToArgs$2, T as TTS_ID, n as getPythonCommandByOs, C as COMFYUI_ID, o as parseArgsToString$3, q as parseStringToArgs$3, r as COMFYUI_ZLUDA_ID, s as getArgumentType, t as isValidArg, u as comfyuizludaArguments, I as INVOKEAI_INSTALL_DIR_KEY, v as INVOKE_ID, w as extractGitUrl, x as INVOKEAI_UPDATE_AVAILABLE_KEY, y as parseArgsToString$4, z as parseStringToArgs$4, B as Invoke_Command_ActivateVenv, D as A1_ID, E as parseArgsToString$5, F as parseStringToArgs$5, S as SD_AMD_ID, G as parseArgsToString$6, H as parseStringToArgs$6, J as SD_NEXT_ID, K as parseArgsToString$7, L as parseStringToArgs$7, M as SWARM_ID, N as parseArgsToString$8, O as parseStringToArgs$8, P as BOLT_DIY_ID, Q as LoLLMS_ID, R as removeAnsi, U as OPEN_WEBUI_ID, V as parseStringToArgs$9, W as parseArgsToString$9, X as SILLYTAVERN_ID, Y as parseArgsToFiles$2, Z as parseFilesToArgs$2, _ as TG_ID, $ as parseArgsToString$a, a0 as parseStringToArgs$a, a1 as isMac, a2 as AITOOLKIT_ID, a3 as parseArgsToString$b, a4 as parseStringToArgs$b, a5 as LORA_MANAGER_ID, a6 as parseArgsToString$c, a7 as parseStringToArgs$c, a8 as KOHYA_ID, a9 as parseArgsToString$d, aa as parseStringToArgs$d, ab as ONETRAINER_ID, ac as SMARTGALLERY_ID, ad as parseArgsToString$e, ae as parseStringToArgs$e, af as SD_FORGE_ID, ag as SD_FORGE_AMD_ID, ah as SD_UIUX_ID, ai as FLOWISEAI_ID, aj as N8N_ID, ak as GeminiCli_ID, al as CLAUDE_CODE_ID, am as APPLIO_ID } from './RendererMethods_f-O-RY.mjs';
import { exec, execSync } from 'node:child_process';
import path, { normalize, join, resolve } from 'node:path';
...
import require$$1$3 from 'node:fs/promises';
...
function requireIndex_min () {
	...
	(function (exports$1) {
var a=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports);var _=a(i=>{Object.defineProperty(i,"__esModule",{value:true});i.sync=i.isexe=void 0;var M=require$$0$6,x=require$$1$3,q=async(t,e={})=>{let{ignoreErrors:r=false}=e;try{return d(await(0,x.stat)(t),e)}catch(s){let n=s;if(r||n.code==="EACCES")return  false;throw n}};i.isexe=q;var m=(t,e={})=>{let{ignoreErrors:r=false}=e;try{return d((0,M.statSync)(t),e)}catch(s){let n=s;if(r||n.code==="EACCES")return  false;throw n}};i.sync=m;var d=(t,e)=>t.isFile()&&A(t,e),A=(t,e)=>{let r=e.uid??process.getuid?.(),s=e.groups??process.getgroups?.()??[],n=e.gid??process.getgid?.()??s[0];if(r===void 0||n===void 0)throw new Error("cannot get uid or gid");let u=new Set([n,...s]),c=t.mode,S=t.uid,P=t.gid,f=parseInt("100",8),l=parseInt("010",8),j=parseInt("001",8),C=f|l;return !!(c&j||c&l&&u.has(P)||c&f&&S===r||c&C&&r===0)};});var g=a(o=>{Object.defineProperty(o,"__esModule",{value:true});o.sync=o.isexe=void 0;var T=require$$0$6,I=require$$1$3,D=path,F=async(t,e={})=>{let{ignoreErrors:r=false}=e;try{return y(await(0,I.stat)(t),t,e)}catch(s){let n=s;if(r||n.code==="EACCES")return  false;throw n}};o.isexe=F;var L=(t,e={})=>{let{ignoreErrors:r=false}=e;try{return y((0,T.statSync)(t),t,e)}catch(s){let n=s;if(r||n.code==="EACCES")return  false;throw n}};o.sync=L;var B=(t,e)=>{let{pathExt:r=process.env.PATHEXT||""}=e,s=r.split(D.delimiter);if(s.indexOf("")!==-1)return  true;for(let n of s){let u=n.toLowerCase(),c=t.substring(t.length-u.length).toLowerCase();if(u&&c===u)return  true}return  false},y=(t,e,r)=>t.isFile()&&B(e,r);});var p=a(h=>{Object.defineProperty(h,"__esModule",{value:true});});var v=exports$1&&exports$1.__createBinding||(Object.create?(function(t,e,r,s){s===void 0&&(s=r);var n=Object.getOwnPropertyDescriptor(e,r);(!n||("get"in n?!e.__esModule:n.writable||n.configurable))&&(n={enumerable:true,get:function(){return e[r]}}),Object.defineProperty(t,s,n);}):(function(t,e,r,s){s===void 0&&(s=r),t[s]=e[r];})),G=exports$1&&exports$1.__setModuleDefault||(Object.create?(function(t,e){Object.defineProperty(t,"default",{enumerable:true,value:e});}):function(t,e){t.default=e;}),w=exports$1&&exports$1.__importStar||(function(){var t=function(e){return t=Object.getOwnPropertyNames||function(r){var s=[];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(s[s.length]=n);return s},t(e)};return function(e){if(e&&e.__esModule)return e;var r={};if(e!=null)for(var s=t(e),n=0;n<s.length;n++)s[n]!=="default"&&v(r,e,s[n]);return G(r,e),r}})(),X=exports$1&&exports$1.__exportStar||function(t,e){for(var r in t)r!=="default"&&!Object.prototype.hasOwnProperty.call(e,r)&&v(e,t,r);};Object.defineProperty(exports$1,"__esModule",{value:true});exports$1.sync=exports$1.isexe=exports$1.posix=exports$1.win32=void 0;var E=w(_());exports$1.posix=E;var O=w(g());exports$1.win32=O;X(p(),exports$1);var H=process.env._ISEXE_TEST_PLATFORM_||process.platform,b=H==="win32"?O:E;exports$1.isexe=b.isexe;exports$1.sync=b.sync;
...
function requireLib () {
	...
	hasRequiredLib = 1;
	const { isexe, sync: isexeSync } = requireIndex_min();
...
async function isGitRoot(dir, repoUrl) {
    try {
        const result = await simpleGit(dir).getRemotes(true);
...
async function checkDirExist(dir) {
    if (!dir)
        return false;
    try {
        await gracefulFsExports.promises.access(dir);
    }
    catch (error) {
        return false;
    }
...
async function checkFilesExist(dir, files) {
    try {
        for (const file of files) {
            ...
            try {
                await gracefulFsExports.promises.access(fullPath);
            }
            catch (error) {
                return false;
            }
...
const DEFAULT_BATCH_DATA$h = isWin ? '@echo off\n\nclaude' : '#!/bin/bash\n\nclaude';
async function getRunCommands$o(configDir) {
    if (!configDir)
        return '';
    const filePath = path.resolve(path.join(configDir, CONFIG_FILE$7));
    await initBatchFile(filePath, DEFAULT_BATCH_DATA$h);
    // Ensure script is executable on Unix
    if (!isWin) {
        await ensureScriptExecutable(filePath);
    }
...
async function saveArgs$i(args, configDir) {
    if (!configDir)
        return;
...
async function readArgs$i(configDir) {
    if (!configDir)
        return [];
    const scriptPath = path.join(configDir, CONFIG_FILE$7);
    await initBatchFile(scriptPath, DEFAULT_BATCH_DATA$h);
    // Ensure script is executable on Unix
    if (!isWin) {
        await ensureScriptExecutable(scriptPath);
    }
...
const ClaudeCode_MM = utils => {
    ...
    return {
        ...
        getRunCommands: () => getRunCommands$o(configDir),
        isInstalled: isInstalled$5,
        saveArgs: args => saveArgs$i(args, configDir),
        readArgs: () => readArgs$i(configDir),
...
const DEFAULT_BATCH_DATA$g = isWin ? '@echo off\n\nnpx flowise start' : '#!/bin/bash\n\nnpx flowise start';
async function getRunCommands$n(configDir) {
    if (!configDir)
        return '';
    const filePath = path.resolve(path.join(configDir, CONFIG_FILE$6));
    await initBatchFile(filePath, DEFAULT_BATCH_DATA$g);
    // Ensure script is executable on Unix
    if (!isWin) {
        await ensureScriptExecutable(filePath);
    }
...
async function saveArgs$h(args, configDir) {
    return await utilSaveArgs(args, CONFIG_FILE$6, parseArgsToString, configDir);
}
async function readArgs$h(configDir) {
    return await utilReadArgs(CONFIG_FILE$6, DEFAULT_BATCH_DATA$g, parseStringToArgs, configDir);
}
...
const Flow_MM = utils => {
    ...
    return {
        ...
        getRunCommands: () => getRunCommands$n(configDir),
        mainIpc: () => mainIpc$7(utils),
        isInstalled: isInstalled$4,
        saveArgs: args => saveArgs$h(args, configDir),
        readArgs: () => readArgs$h(configDir),
...
const DEFAULT_BATCH_DATA$f = isWin ? '@echo off\n\ngemini' : '#!/bin/bash\n\ngemini';
async function getRunCommands$m(configDir) {
    if (!configDir)
        return '';
    const filePath = path.resolve(path.join(configDir, CONFIG_FILE$5));
    await initBatchFile(filePath, DEFAULT_BATCH_DATA$f);
    // Ensure script is executable on Unix
    if (!isWin) {
        await ensureScriptExecutable(filePath);
    }
...
async function saveArgs$g(args, configDir) {
    if (!configDir)
        return;
...
async function readArgs$g(configDir) {
    if (!configDir)
        return [];
    const scriptPath = path.join(configDir, CONFIG_FILE$5);
    await initBatchFile(scriptPath, DEFAULT_BATCH_DATA$f);
    // Ensure script is executable on Unix
    if (!isWin) {
        await ensureScriptExecutable(scriptPath);
    }
...
const GeminiCli_MM = utils => {
    ...
    return {
        ...
        getRunCommands: () => getRunCommands$m(configDir),
        isInstalled: isInstalled$3,
        saveArgs: args => saveArgs$g(args, configDir),
        readArgs: () => readArgs$g(configDir),
...
async function readArgs$f(configDir) {
    return await utilReadArgs(CONFIG_FILE$4, DEFAULT_BATCH_DATA$e, parseStringToArgs$1, configDir);
}
...
const BAT_FILE_NAME$d = isWin ? 'start_alltalk.bat' : 'start_alltalk.sh';
async function getRunCommands$k() {
    return await utilRunCommands(BAT_FILE_NAME$d);
}
const Rrew123_MM = utils => {
    const installDir = utils.getInstallDir(ALLTALK_ID);
    return {
        getRunCommands: () => getRunCommands$k(),
        isInstalled: () => isGitTypeInstalled(installDir, 'https://github.com/erew123/alltalk_tts', [BAT_FILE_NAME$d]),
    };
};
...
const BAT_FILE_NAME$c = isWin ? 'lynx-user.bat' : 'lynx-user.sh';
const DEFAULT_BATCH_DATA$d = isWin ? '@echo off\n\ncall run.bat' : '#!/bin/bash\n\nbash ./run.sh';
async function getRunCommands$i(dir) {
    return await utilRunCommands(BAT_FILE_NAME$c, dir, DEFAULT_BATCH_DATA$d);
}
async function saveArgs$e(args, dir) {
    return await utilSaveArgs(args, BAT_FILE_NAME$c, parseArgsToString$2, dir);
}
async function readArgs$e(dir) {
    return await utilReadArgs(BAT_FILE_NAME$c, DEFAULT_BATCH_DATA$d, parseStringToArgs$2, dir);
}
const Gitmylo_MM = utils => {
    ...
    return {
        ...
        isInstalled: () => isGitTypeInstalled(installDir, 'https://github.com/gitmylo/audio-webui', [BAT_FILE_NAME$c]),
    };
};

const BAT_FILE_NAME$b = isWin ? 'start_tts_webui.bat' : 'start_tts_webui.sh';
async function getRunCommands$h(dir) {
    return await utilRunCommands(BAT_FILE_NAME$b, dir);
}
const Rsx_MM = utils => {
    const installDir = utils.getInstallDir(TTS_ID);
    return {
        getRunCommands: () => getRunCommands$h(installDir),
        isInstalled: () => isGitTypeInstalled(installDir, 'https://github.com/rsxdalv/TTS-WebUI', [BAT_FILE_NAME$b]),
    };
};

const BAT_FILE_NAME$a = isWin ? 'lynx-user.bat' : 'lynx-user.sh';
const pythonCommand$1 = getPythonCommandByOs().python;
const DEFAULT_BATCH_DATA$c = isWin
...
async function saveArgs$d(args, dir) {
    return await utilSaveArgs(args, BAT_FILE_NAME$a, parseArgsToString$3, dir);
}
async function readArgs$d(dir) {
    return await utilReadArgs(BAT_FILE_NAME$a, DEFAULT_BATCH_DATA$c, parseStringToArgs$3, dir);
}
...
async function saveArgs$c(args, dir) {
    ...
    const fileContent = await gracefulFsExports.promises.readFile(filePath, 'utf-8');
    ...
    try {
        if (await gracefulFsExports.promises
            .access(originalFilePath)
            .then(() => true)
            .catch(() => false)) {
            const originalContent = await gracefulFsExports.promises.readFile(originalFilePath, 'utf-8');
    ...
    await gracefulFsExports.promises.writeFile(filePath, cleanedLines.join('\n'), 'utf-8');
}
                ...
                if (cleanEnvName === 'PYTHON' ||
                    ...
                    args.forEach(arg => {
                        ...
                        if (isValidArg(argName, comfyuizludaArguments)) {
                            const argType = getArgumentType(argName, comfyuizludaArguments);
                            if (argType === 'CheckBox') {
...
async function getRunCommands$d(dir) {
    return await utilRunCommands(EXEC_FILE$1, dir, DEFAULT_BATCH_DATA$a);
}
...
async function readArgs$a(dir) {
    return await utilReadArgs(CONFIG_FILE$2, DEFAULT_BATCH_DATA$a, parseStringToArgs$5, dir);
}
...
const DEFAULT_BATCH_DATA$7 = isWin
...
const McMonkey_MM = utils => {
    ...
    return {
        ...
        isInstalled: () => isGitTypeInstalled(installDir, 'https://github.com/mcmonkeyprojects/SwarmUI', [
...
async function saveArgs$4(args, dir) {
    return await utilSaveArgs(args, BAT_FILE_NAME$5, parseArgsToString$a, dir);
}
async function readArgs$4(dir) {
    return await utilReadArgs(BAT_FILE_NAME$5, DEFAULT_BATCH_DATA$4, parseStringToArgs$a, dir);
}
const Ooba_MM = utils => {
    ...
    return {
        ...
        isInstalled: () => isGitTypeInstalled(installDir, 'https://github.com/oobabooga/text-generation-webui', [
...
async function saveArgs$3(args, dir) {
    return await utilSaveArgs(args, BAT_FILE_NAME$4, parseArgsToString$b, dir);
}
async function readArgs$3(dir) {
    return await utilReadArgs(BAT_FILE_NAME$4, DEFAULT_BATCH_DATA$3, parseStringToArgs$b, dir);
}
...
async function saveArgs$2(args, dir) {
    ...
    await utilSaveArgs(args, BAT_FILE_NAME$3, parseArgsToString$c, dir);
    // Save settings.json
    ...
    args.forEach(arg => {
        if (arg.name === 'civitai_api_key' && arg.value) {
            settings.civitai_api_key = arg.value;
        }
            ...
            settings.folder_paths.loras = arg.value
                .split(',')
                .map(p => p.trim())
                .filter(Boolean);
        }
        else if (arg.name === 'checkpoints_folders' && arg.value) {
            settings.folder_paths.checkpoints = arg.value
                .split(',')
                .map(p => p.trim())
                .filter(Boolean);
        }
        else if (arg.name === 'embeddings_folders' && arg.value) {
            settings.folder_paths.embeddings = arg.value
                .split(',')
                .map(p => p.trim())
                .filter(Boolean);
        }
        else if (arg.name === 'auto_organize_exclusions' && arg.value) {
            settings.auto_organize_exclusions = arg.value
                .split(',')
                .map(p => p.trim())
                .filter(Boolean);
        }
...
async function readArgs$2(dir) {
    ...
    const cmdArgs = await utilReadArgs(BAT_FILE_NAME$3, DEFAULT_BATCH_DATA$2, parseStringToArgs$c, dir);
    // Read settings.json
    const settingsPath = path.join(dir, SETTINGS_FILE);
...
const LoraManager_MM = utils => {
    ...
    return {
        ...
        isInstalled: () => isGitTypeInstalled(installDir, 'https://github.com/willmiao/ComfyUI-Lora-Manager', [
            'standalone.py',
            'requirements.txt',
        ]),
    };
...
async function saveArgs$1(args, dir) {
    return await utilSaveArgs(args, BAT_FILE_NAME$2, parseArgsToString$d, dir);
}
async function readArgs$1(dir) {
    return await utilReadArgs(BAT_FILE_NAME$2, DEFAULT_BATCH_DATA$1, parseStringToArgs$d, dir);
}
...
async function saveArgs(args, dir) {
    return await utilSaveArgs(args, BAT_FILE_NAME, parseArgsToString$e, dir);
}
async function readArgs(dir) {
    return await utilReadArgs(BAT_FILE_NAME, DEFAULT_BATCH_DATA, parseStringToArgs$e, dir);
}
const SmartGallery_MM = utils => {
    ...
    return {
        ...
        isInstalled: () => isGitTypeInstalled(installDir, 'https://github.com/biagiomaf/smart-comfyui-gallery', [
            'smartgallery.py',
            'requirements.txt',
        ]),
    };
